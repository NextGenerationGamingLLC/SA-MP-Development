...
hook OnGameModeInit() {
	...
	CrateLoad = CreateDynamicObject(964, 134.7094,-4380.9165,50.7603,0.00000000,0.00000000,180.00000000, .worldid = 0, .interiorid = 1, .streamdistance = 200); //object(cj_metal_crate) (1)
