...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[]) {
	...
	switch(dialogid) {
		...
		case INTERACT_DRUGSCONFIRM: {
			...
			format(szMiscArray, sizeof(szMiscArray), "You have given %s %dg of %s.", GetPlayerNameEx(giveplayerid), strval(inputtext), PlayerInfo[playerid][pDrugs][GetPVarInt(playerid, "Interact_Drug")]);
			SendClientMessageEx(playerid, COLOR_WHITE, szMiscArray);
